...
const signUpSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
    username: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$schemas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().min(2, "Username must be at least 2 characters"),
...
const SignUpForm = ()=>{
    ...
    const useToast = ()=>({
            toast: (options)=>{
                alert("".concat(options.title, ": ").concat(options.description));
            }
        });
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SignUpForm.useEffect": ()=>{
            const checkUsernameUnique = {
                "SignUpForm.useEffect.checkUsernameUnique": async ()=>{
                    if (debouncedUsername) {
                        ...
                        try {
                            ...
                            await new Promise({
                                "SignUpForm.useEffect.checkUsernameUnique": (resolve)=>setTimeout(resolve, 500)
                            }["SignUpForm.useEffect.checkUsernameUnique"]);
                            const response = {
                                data: {
                            ...
                            setUsernameMessage((_axiosError_response_data_message = (_axiosError_response = axiosError.response) === null || _axiosError_response === void 0 ? void 0 : _axiosError_response.data.message) !== null && _axiosError_response_data_message !== void 0 ? _axiosError_response_data_message : 'Error checking username');
                        } finally{
    ...
    const onSubmit = async (data)=>{
        ...
        try {
            ...
            const mockResponse = {
                data: {
                    message: 'Successfully registered! A verification code has been sent to your email.',
                    success: true
                }
            };
            // --- END OF MOCK ---
            ...
            router.replace("/verify/".concat(data.username));
        } catch (error) {
            var _axiosError_response;
            console.error('Error during sign-up:', error);
            const axiosError = error;
            var _axiosError_response_data_message;
            let errorMessage = (_axiosError_response_data_message = (_axiosError_response = axiosError.response) === null || _axiosError_response === void 0 ? void 0 : _axiosError_response.data.message) !== null && _axiosError_response_data_message !== void 0 ? _axiosError_response_data_message : 'There was a problem with your sign-up. Please try again.';
            toast({
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            className: "mb-4",
                            children: "Sign up to start your anonymous adventure"
                        }, void 0, false, {
                            fileName: "[project]/src/app/(auth)/sign-up/page.tsx",
                            lineNumber: 154,
                            columnNumber: 11
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            children: [
                                ...
                                isCheckingUsername && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Loader2, {
                                ...
                                !isCheckingUsername && usernameMessage && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "text-sm mt-2 ".concat(usernameMessage === 'Username is unique' ? 'text-green-500' : 'text-red-500'),
...
_s1(SignUpForm, "qLCIaW49/cAb/fEm3E5JSSx8A1E=", true, function() {
    return [
        useDebounce,
        useRouter,
...
var _c, _c1;
__turbopack_context__.k.register(_c, "Loader2");
...
//# sourceMappingURL=src_app_%28auth%29_sign-up_page_tsx_a6de6348._.js.map